...
file_alignment_df = pd.read_csv('file_alignment_sort.csv',index_col=0)
...
df_inner = pd.merge(file_alignment_df,sample_dropped_df,how='inner',on=['sample_submitter_id','sample_type'])
